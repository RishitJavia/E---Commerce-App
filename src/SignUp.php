...
<table class="t" style="border-collapse: collapse;border-color: white">
<center >
<tr class="attr"><th class="label">First Name </th><td style="border-color: white"><input id="fn" class="sub" type = "text" name="cfn" style="color:black" ></td></tr>
<tr class="attr"><th class="label">Last Name </th><td style="border-color: white"><input id="ln" class="sub" type = "text" name="cln" style="color:black" ></td></tr>
<tr class="attr"><th class="label">Password </th><td style="border-color: white"><input id="pass" class="sub" type = "password" name="pass" style="color:black" ></td></tr>
<tr class="attr"><th class="label">Contact No </th><td style="border-color: white"><input id="cn" class="sub" type = "tel" name="cp" style="color:black" ></td></tr>
<tr class="attr"><th class="label">Email ID </th><td style="border-color: white"><input id="em" class="sub" type = "text" name="eid" style="color:black" ></td></tr>
