...
<table class="t" style="border-collapse: collapse;border-color: white">
<center >
<tr class="attr"><th class="label">Customer ID </th><td class="l" style="border-color: white"><?php echo $row1['Customer_ID'] . " "; ?></td></tr>
<tr class="attr"><th class="label">First Name </th><td class="l" style="border-color: white"><?php echo $row1['Customer_fname'] . " "; ?></td></tr>
<tr class="attr"><th class="label">Last Name </th><td class="l" style="border-color: white"><?php echo $row1['Customer_lname'] . " "; ?></td></tr>
<tr class="attr"><th class="label">Contact No </th><td  class="l" style="border-color: white"><?php echo $row1['Customer_phone'] . " "; ?></td></tr>
<tr class="attr"><th class="label">Email ID </th><td  class="l" style="border-color: white"><?php echo $row1['Email_ID'] . " "; ?></td></tr>

</center>
</table>
<?php

$sql = "select * from order1 where Customer_ID ='".$cid."' ";
$res= mysqli_query($link,$sql);
while($row2 = mysqli_fetch_array($res))
{
	
	$q = "select * from product where Product_ID ='".$row2['Product_ID']."' ";
