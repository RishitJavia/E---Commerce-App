...
<div class="wrapper row1">
  <header id="header" class="hoc clear"> 
    <div id="logo" class="fl_left">
      <h1><a href="Home.php">Shop24</a></h1>
    </div>
...
$sql = "SELECT * from product where Product_name LIKE '". $search. "' OR Category LIKE '". $search. "' OR Brand LIKE '". $search. "' Description LIKE '". $search. "' ";
