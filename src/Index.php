...
<center >
<tr class="attr" ><td style="border-color: white"><input id="search" class="in" type = "text" style="color:black" placeholder="Search for products, brands and more" name="search" ></td><td><input style="font-weight:bold; color:white; background-color:#006699;padding:2.5% 0 2.5% 0;" class="in" type="submit"  value="Search" ></td></tr>
</table>
...
if(isset($_GET['cat']) && isset($_GET['ord'])){
	$cat =  $_GET['cat'];
	$ord =  $_GET['ord'];
	$_SESSION['Category']=$cat;
	$_SESSION['ord']=$ord;
...
else if(!isset($_GET['cat']) && isset($_GET['ord'])){
	$ord =  $_GET['ord'];
	$_SESSION['ord']=$ord;
